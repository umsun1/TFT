...
- **해결:**
    ...
    - **비동기 큐 기반 100% 위임:** 사용자의 티어, 레벨, 닉네임 등 프로필 렌더링을 위한 기본 필수 정보만 API로 즉시 동기 호출하여 응답하고, 수백 건의 무거운 매치 상세 수집 작업은 **Redis 큐에 100% 비동기로 위임(Push)하여 백그라운드에서 배치 서버가 수집(Pop)** 하도록 설계했습니다.
